...
from dsw_data_seeder.logging import LOGGER

if TYPE_CHECKING:
    from dsw_data_seeder.config import SeederConfig
    from dsw_data_seeder.connection.database import Database
...
class Context:
    ...
    @classmethod
    def update_item_id(cls, item_id: str):
        cls.logger.item_id = item_id
